...
public class PointcloudActivity extends Activity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.capture_frame).setOnClickListener(this);
    findViewById(R.id.reset_frame).setOnClickListener(this);
    findViewById(R.id.save_to_file).setOnClickListener(this);
  ...
  public void onClick(View v) {
    ...
    case R.id.top_down_button:
      ...
      case R.id.capture_frame:
        TangoJNINative.setCapture(0);
        break;
      case R.id.reset_frame:
        TangoJNINative.setCapture(1);
        break;
      case R.id.save_to_file:
        TangoJNINative.setCapture(2);
        break;
    default:
      return;
    }
